...
describe('cancel', () => {
  ...
  describe('when called before sending request', () => {
    it('should rejects Promise with a Cancel object', function() {
  ...
  describe('when called after request has been sent', () => {
    it('should rejects Promise with a Cancel object', function(done) {
      const source = CancelToken.source()
      axios
        .get('/foo/bar', {
          cancelToken: source.token
    ...
    it('calls abort an request object', function(done) {
      const source = CancelToken.source()
      let request: any
  ...
  describe('when called after response has been received', () => {
    it('should not cause unhandled rejection', function(done) {
      const source = CancelToken.source()
      axios
        .get('/foo', {
          cancelToken: source.token
